    ...
    public List<SeckillSkuRedisTO> getCurrentSeckillSkus() {
        ...
        for (String key : keys) {
            ...
            if (currentTime >= startTime && currentTime <= endTime) {
                ...
                break;
                //  这里似乎只能查出一个秒杀场次,
                //  而且只能查已经开始秒杀的商品，(展示在首页，这里应该没有问题；没到秒杀时间时，商品详情页会显示"商品将会在2022-07-04 00:00:00进行秒杀",且没有“立即抢购”按钮)
                //  查出来如果只有场次没有商品就直接break了;  by luordcat
            }
        }
                    ...
                    if (isRepeat) {
                        ...
                        if (isAcquire) {
                            ...
                            return orderSn;
                             ...
                             //TODO 占位成功但没拿到信号量，需要delete userkey 准备下一次秒杀
                        }
                    }
                }
            }
